...
var socket = io();
socket.on('server:newuser', function () {
  alert("new connection");
});

var notifyMessage = function notifyMessage(msg) {
  socket.emit('client:newmsg', msg);
  console.log("Sending message to ws ...");
};

socket.on('server:loadmsgs', function (msgs) {
  var data = msgs.data;
